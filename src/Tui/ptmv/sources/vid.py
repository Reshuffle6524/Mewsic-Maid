...
def play(file, width, height, target_fps, start_offset):
	...
	return video_loop(video, audio, out_width / orig_width, out_height / orig_height, target_fps, start_offset)
...
def video_loop(video, audio, scale_x, scale_y, target_fps, start_offset):
	...
	while True:
		...
		if current_time - prev_time > dt:
			...
			console_img=(console.draw_frame(prev_frame, current_frame))
			prev_frame = current_frame

		a.append(console_img)
